                  ...
                  <form method="post" action="" enctype="multipart/form-data" >
                    <div class="form-group">
                      ...
                      <select class="form-control text-pks" id="jenis" name="jenis">
                        <?php if ($mutasi['jenis_mutasi'] == 'Masuk') : ?>
                          <option value="Masuk" selected class="text-pks">Masuk</option>
                          <option value="Keluar" class="text-pks">Keluar</option>
                          <?php else :  ?>
                            <option value="Masuk" class="text-pks">Masuk</option>
                            <option value="Keluar" selected="" class="text-pks">Keluar</option>
                          <?php  endif?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select name="dpc_id" id="dpc_id" class="form-control select2 text-pks">
                          <?php if ($mutasi['dpc'] == $kader['dpc_id']): ?>
                            <option selected="" value="<?=$mutasi['dpc'] ?>" ><?=$kader['nama_dpc']  ?></option>
                          <?php endif ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="dpra_id" id="dpra_id" class="form-control select2">
                          <?php if ($mutasi['dpra'] == $kader['dpra_id']): ?>
                            <option selected="" value="<?=$mutasi['dpra'] ?>" ><?=$kader['nama_dpra']  ?></option>
                          <?php endif ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="catatan" id="catatan" class="form-control text-pks"><?=$mutasi['catatan'] ?></textarea>
                      </div>
                      <input hidden="" type="text" name="oldfile" id="oldfile" value="<?=$mutasi['file'] ?>">
                      <div class="form-group">
