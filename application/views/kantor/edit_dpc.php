        ...
        <div class="card-body">
          <form method="post" action="">
            <div class="form-group">
              ...
              <input type="text" class="form-control text-pks" value="<?=$dpc['nama_dpc'] ?>" id="nama_dpc" name="nama_dpc" placeholder="Nama kantor DPC...">
              <?= form_error('nama_dpc', '<small class="text-danger">', '</small>') ?>
            </div>
            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">No Handphone Kantor</label>
              <input type="text" class="form-control text-pks" value="<?=$dpc['no_telp_dpc'] ?>" id="no_hp" name="no_hp" placeholder="No Handphone kantor...">
              <?= form_error('no_hp', '<small class="text-danger">', '</small>') ?>
            </div>
            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Alamat Kantor</label>
              <textarea type="text" class="form-control text-pks" id="alamat" name="alamat" placeholder="Alamat..."><?=$dpc['alamat_dpc'] ?></textarea>
