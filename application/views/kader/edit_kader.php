        ...
        <div class="card-body">
          <form method="post" action="">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control text-pks" id="no_anggota" name="no_anggota" value="<?=$kader['no_anggota'] ?>" placeholder="No Anggota...">
              <?= form_error('no_anggota', '<small class="text-danger">', '</small>') ?>
            </div>
            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Nama</label>
              <input type="text" class="form-control text-pks" id="nama_kader" name="nama_kader" value="<?=$kader['nama'] ?>" placeholder="Nama Kader...">
              <?= form_error('nama_kader', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">NIK</label>
              <input type="text" class="form-control text-pks" id="nik_kader" name="nik_kader" value="<?=$kader['nik'] ?>" placeholder="NIK Kader...">
              <?= form_error('nik_kader', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">No Hp Kader</label>
              <input type="text" class="form-control text-pks" id="no_hp_kader" name="no_hp_kader" value="<?=$kader['no_hp'] ?>" placeholder="No Hp Kader...">
              <?= form_error('no_hp_kader', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Email</label>
              <input type="text" class="form-control text-pks" id="email" name="email" value="<?=$kader['email'] ?>" placeholder="Email Kader...">
              <?= form_error('email', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Alamat</label>
              <textarea type="text" class="form-control text-pks" id="alamat" name="alamat" placeholder="Alamat..."><?=$kader['alamat'] ?></textarea>
              <?= form_error('alamat', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Pembina</label>
              <input type="text" class="form-control text-pks" id="pembina" name="pembina" value="<?=$kader['pembina'] ?>" placeholder="Pembina Kader...">
              <?= form_error('pembina', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Pendidikan</label>
              <input type="text" class="form-control text-pks" id="pendidikan" name="pendidikan" value="<?=$kader['pendidikan'] ?>" placeholder="Pendidikan Kader...">
              <?= form_error('pendidikan', '<small class="text-danger">', '</small>') ?>
            </div>

            <div class="form-group">
              <label for="" class="text-pks font-weight-bold">Catatan</label>
              <textarea type="text" class="form-control text-pks" id="catatan" name="catatan" placeholder="Catatan(Opsional)..."><?=$kader['catatan'] ?></textarea>
              <?= form_error('catatan', '<small class="text-danger">', '</small>') ?>
            </div>
            <div class="form-group">
              <button type="submit" class="btn btn-pks">Perbarui</button>
            </div>
          </form>
        </div>
      </div>
